...
│ # │ Path                       │ Status │ Type  │
│───┼─────────────────────────────┼────────┼───────┤
│ 1 │ C:\Windows\system32         │ ✓ OK   │ [S]  │
│ 2 │ C:\Python311                │ ✓ OK   │ [U]  │
│ 3 │ C:\NonExistent\Path         │ ✗     │ [U]  │
├─────────────────────────────────────────────────┤
│ Status: 45 entries | 42 OK | 3 Not Found       │
└─────────────────────────────────────────────────┘
```

### Color Coding
- 🟦 **Blue rows** = System PATH entries
- 🟩 **Green rows** = User PATH entries  
- ✅ **Green check** = Directory exists
- ❌ **Red X** = Directory not found
